    ...
    <>
      <motion.div
        className={cn(
          ...
          'text-[13px] font-normal tracking-[-0.01em] text-white/90'
        )}
        style={{
      ...
      >
        <div className="flex items-center h-full">
          ...
          <nav className="flex items-center h-full text-white/80">
            {['Fichier', 'Édition', 'Présentation', 'Aller', 'Fenêtre', 'Aide'].map(item => (
              <button key={item} className="hover:bg-white/10 px-[8px] h-full flex items-center transition-colors text-[13px] rounded-[3px]">
                {item}
              </button>
            ))}
          </nav>
        ...
        <div className="flex items-center h-full gap-[2px]">
          ...
          <button
            className={cn(
              'hover:bg-white/10 px-[6px] h-full flex items-center transition-colors rounded-[3px]',
              showControlCenter && 'bg-white/15'
            )}
        ...
        {showSpotlight && (
          ...
          >
            <motion.div
              ...
              style={{
                background: 'rgba(30,30,35,0.75)', backdropFilter: 'blur(60px) saturate(200%)', WebkitBackdropFilter: 'blur(60px) saturate(200%)',
            ...
            >
              <div className="flex items-center gap-3 px-4 py-3">
                ...
                <input autoFocus type="text" placeholder="Recherche Spotlight"
